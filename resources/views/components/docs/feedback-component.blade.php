<div class="feedback-card" data-page-id="{{ $page->id }}">
    <div class="p-3">
                ...
                <button type="button" data-rating="4">
                    <svg viewBox="0 0 16 16" height="16" width="16" fill="currentColor">
                        <path fill-rule="evenodd"
                            ...
                            clip-rule="evenodd"></path>
                        <path fill-rule="evenodd"
                            d="M6.15 4.92 5.37 3.5 4.6 4.92l-1.6.3 1.12 1.17L3.9 8l1.47-.7 1.46.7-.2-1.6 1.11-1.18zm5.25 0-.78-1.42-.77 1.42-1.6.3 1.12 1.17L9.16 8l1.47-.7 1.46.7-.2-1.6L13 5.21z"
                            clip-rule="evenodd"></path>
                    </svg>
                </button>
            </div>
        ...
        <textarea class="form-control mb-2" rows="4" placeholder="Your Feedback..."></textarea>
    ...
    <div class="card-footer">
        <button class="btn btn-dark ms-auto">Send</button>
    </div>
</div>
