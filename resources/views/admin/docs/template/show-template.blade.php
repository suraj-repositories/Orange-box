            ...
            <div class="container-xxl">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    ...
                    <div class="text-end">
                        <ol class="breadcrumb m-0 py-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.docs.templates.index') }}">Templates</a>
                            </li>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="card border my-2 shadow-none">
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    <strong>Documentation Type</strong>
                                    <span>{{ ($template->price ?? 0) == 0 ? 'Free' : 'Premium' }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        @if (($template->price ?? 0) != 0)
                            <div class="card border my-2 shadow-none">
                                <div class="card-body py-2">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                        <strong>Documentation Price</strong>
                                        <span>
                                            <del
                            ...
                            <div class="card border my-2 shadow-none">
                                <div class="card-body py-2">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                        ...
                                        <span>{{ $template->purchases_count ?? 0 }}</span>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="card border my-2 shadow-none">
                            <div class="card-body py-2">
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    <strong>Used In Documentations</strong>
                                    <span>{{ $template->documentations_count ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
