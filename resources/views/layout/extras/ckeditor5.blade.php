<script type="module">
    ...
    function initCKEditor(editorElement) {
        // 1. Check if an editor instance already exists and destroy it.
        // This ensures a fresh, non-collapsed editor on every open.
        if (editorElement.editorInstance) {
            editorElement.editorInstance.destroy()
                .then(() => {
                    editorElement.editorInstance = null;
                    editorElement.dataset.editorInitialized = ''; // Reset flag
