<div class="d-flex gap-2 flex-wrap">
    <button class="btn btn-primary rounded-3" data-bs-toggle="modal" data-bs-target="#refreshPagesModal">
        Refresh Pages
    </button>
    ...
    <div class="modal fade" id="refreshPagesModal" tabindex="-1" aria-labelledby="refreshPagesModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="#" method="POST" data-submit-type="ajax">
                    @csrf
    ...
    <button class="btn btn-primary rounded-3" data-bs-toggle="modal" data-bs-target="#loadDocsModal">
        Load Entire Docs
    </button>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="docsUrl" name="github_url"
                                value="{{ $documentation?->load_url }}" placeholder="https://example.com/docs" required>
                            <div class="form-text">
