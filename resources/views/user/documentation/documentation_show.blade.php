                ...
                <div class="row g-3">
                                        ...
                                        <div class="card mb-0 rounded-4 border">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <div class="modal fade" id="loadDocsModal" tabindex="-1"
                    ...
                    <div class="col-md-12">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                <x-user.analytics.documentation-audience-heatmap-card :documentation-id="$documentation->id" :release-id="$release->id" />
                            </div>
                        </div>
                    </div>
                </div>
