        ...
        <div class="content">
            <div class="container-xxl">
                ...
                <div class="row">
                    <div class="col-12">
                        <form
                            action="{{ authRoute('user.documentation.terms.save', ['documentation' => $documentation, 'release' => $release]) }}"
                            id="saveTermsForm" method="POST">
                            @csrf
                            <div class="card">
                                <div
                                ...
                                <div class="card-body">
                                    <div id="editorjs-editor" data-ob-submit-form="#saveTermsForm"
