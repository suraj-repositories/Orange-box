                                                                        ...
                                                                        <div class="col-12">
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label for="logo_light_input"
                                                                                    class="form-label">Sponser Logo's</label>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($sponsors as $sponsor)
                                                <tr>
                                                    ...
                                                    {{-- <td style="max-width: 400px" class="text-truncate"> {!! Str::markdown($sponsor->description ?? '-') !!}</td> --}}
                                                    <td>
                                                        {{ $sponsor->tier ?? '-' }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input sponsorStatusToggleSwitch"
                                                                type="checkbox" role="switch"
                                                                data-documentation-sponsor-id="{{ $sponsor->id }}"
