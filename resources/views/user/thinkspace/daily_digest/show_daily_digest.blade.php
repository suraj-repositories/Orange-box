                            ...
                            <div class="align-items-center">
                                <div class="d-flex flex-column flex-md-row align-items-center">
                                    ...
                                    <div class="overflow-hidden mt-3 mt-md-0 ms-md-4">
                                        ...
                                        <span class="fs-15">
                                            <button class="like-btn" data-daily-digest-id='{{ $dailyDigest->id }}'>
                                                <i class="mdi {{ $dailyDigest->likedBy(auth()->id()) ? 'mdi-thumb-up' : 'mdi-thumb-up-outline' }} me-1 align-middle"></i>
                                            </button>
                                            @php $likes = $dailyDigest->likesCount(); @endphp
                                            <span id="like-count" data-daily-digest-id='{{ $dailyDigest->id }}'>{{ $likes > 0 ? $likes : 'Like' }} </span>

                                            <button class="dislike-btn" data-daily-digest-id='{{ $dailyDigest->id }}'>
                                                <i class="mdi {{ $dailyDigest->dislikedBy(auth()->id()) ? 'mdi-thumb-down' : 'mdi-thumb-down-outline' }} me-1 ms-1 align-middle"></i>
                                            </button>
