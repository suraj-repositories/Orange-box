            ...
            <div class="container-xxl">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">{{ empty($thinkPad) ? 'Create' : 'Edit' }} Think Pad</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">{{ empty($thinkPad) ? 'Create' : 'Edit' }} Pad</h5>
                            </div><!-- end card header -->
                                        ...
                                        <div class="col col-12 col-md-6  mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter title"
                                                    ...
                                                    value="{{ !empty($thinkPad) ? $thinkPad->title : '' }}">
                                            </div>
                                            @error('title')
                                        ...
                                        <div class="col col-12 col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter sub_title"
                                                    ...
                                                    value="{{ !empty($thinkPad) ? $thinkPad->sub_title : '' }}">
                                            </div>
                                            @error('sub_title')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
