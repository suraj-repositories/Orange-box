...
function enableVarificationMethodToggle() {
    const inputGroups = document.querySelectorAll(".input-group-wrapper");
...
async function handlePemSelection(input, password_locker_id) {
...
function handleAppSelection(input, password_locker_id) {
