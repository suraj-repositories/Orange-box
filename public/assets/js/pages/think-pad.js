...
function enableLikeDislike() {
    ...
    likeBtn.addEventListener('click', () => {
        const thinkPad = likeBtn.getAttribute('data-think-pad-id');
        const url = authRoute('user.think-pad.like', { thinkPad: thinkPad });
        apiCall(url)
    });

    dislikeBtn.addEventListener('click', () => {
        const thinkPad = likeBtn.getAttribute('data-think-pad-id');
        const url = authRoute('user.think-pad.dislike', { thinkPad: thinkPad });
        apiCall(url);
    });
}
