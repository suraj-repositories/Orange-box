...
// ------------------------------------------------------
function enableMediaInput(select) {

    const mediaInputElement = document.querySelector(select);
    ...
    enableMediaSubmit(mediaInputElement.closest('form[enctype="multipart/form-data"]'));
...
// ------------------------------------------------------
function enableMediaSubmit(form) {
