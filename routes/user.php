...
Route::controller(DocumentationDocumentController::class)->group(function () {
    ...
    Route::prefix('documentation/{documentation}/documentation-doc/pages')->group(function () {
        Route::get('list', 'list')->name('documentation.document.pages.list');
        Route::post('/', 'store')->name('documentation.document.pages.store');
        Route::get('{document}', 'show')->name('documentation.document.pages.show');
        Route::put('{document}', 'update')->name('documentation.document.pages.update');
        Route::delete('{document}', 'destroy')->name('documentation.document.pages.destroy');
        Route::patch('{document}/toggle', 'toggle')->name('documentation.document.pages.toggle');
    });
...
Route::controller(DocumentationSponsorController::class)->group(function () {
    Route::get('documentation-doc/{document}/sponsors', 'index')->name('documentation.document.sponsors.index');
    Route::post('documentation-doc/{document}/sponsors', 'save')->name('documentation.sponsors.save');
    Route::post('documentation-doc/{document}/sponsors-content', 'updateContent')->name('documentation.sponsors.content.save');
